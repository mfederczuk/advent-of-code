...
#ifndef YEAR2022_DAY02_DYNAMIC_SSO_STRING_H
#define YEAR2022_DAY02_DYNAMIC_SSO_STRING_H
...
static inline int dynamic_sso_string_append(struct dynamic_sso_string* const s,
                                            const char* const buf,
                                            const size_t buf_size) {
...
#endif /* YEAR2022_DAY02_DYNAMIC_SSO_STRING_H */
